<div class="row">
	<ul class="nav nav-pills">
	  ...
	  <li role="presentation" class="active"><a href="<?php echo base_url();?>editpuerto/0"><i class="fa fa-pencil"></i> Editar</a></li>
...
<div class="row">
	...
	<div class="panel panel-default">
		...
		<form class="form-horizontal" method="POST" action="<?php echo base_url();?>editpuerto/0">
		  <div class="form-group">
		    <label for="code" class="col-sm-2 control-label">Locoode</label>
		    <div class="col-sm-4">
		      <input name="locode" type="text" class="form-control" id="locode" placeholder="Locode" value="<?php if(isset($locode)) echo $locode; else echo set_value('locode'); ?>" aria-describedby="inputError2Status">
