<div class="row">
	<ul class="nav nav-pills">
	  <li role="presentation" class="active"><a href="<?php echo base_url();?>addpuerto"><i class="fa fa-plus-square"></i> Agregar</a></li>
	  <li role="presentation"><a href="<?php echo base_url();?>editpuerto/0"><i class="fa fa-pencil"></i> Editar</a></li>
	  <li role="presentation"><a href="<?php echo base_url();?>deletepuerto/0"><i class="fa fa-trash"></i> Eliminar</a></li>
	</ul>
</div>
<div class="row">
	...
	<div class="panel panel-default">
		...
		<form class="form-horizontal" method="POST" action="<?php echo base_url();?>addpuerto">
		  <div class="form-group">
		    <label for="code" class="col-sm-2 control-label">Locode</label>
		    <div class="col-sm-4">
		      <input name="locode" type="text" class="form-control" id="locode" placeholder="Locode" value="<?php echo set_value('locode'); ?>" aria-describedby="inputError2Status">
		    </div>
		  </div>
		  <div class="form-group <?php if(form_error('puerto')!='') echo 'has-error';?>">
		    <label for="pais" class="col-sm-2 control-label">Puerto</label>
		    <div class="col-sm-4">
		      <input name="puerto" type="text" class="form-control" id="Puerto" placeholder="Puerto" value="<?php echo set_value('puerto'); ?>" aria-describedby="inputError2Status">
		    </div>
		  </div>
		  <div class="form-group">
