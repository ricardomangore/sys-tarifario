<div class="row">
	<ul class="nav nav-pills">
	  ...
	  <li role="presentation" class="active"><a href="<?php echo base_url();?>editnaviera/0"><i class="fa fa-pencil"></i> Editar</a></li>
...
<div class="row">
	...
	<div class="panel panel-default">
		...
		<form class="form-horizontal" method="POST" action="<?php echo base_url();?>editnaviera/0">
		  <div class="form-group <?php if(form_error('naviera')!='') echo 'has-error';?>">
		    ...
		    <div class="col-sm-4">
		      <input name="naviera" type="text" class="form-control" id="naviera" placeholder="Naviera" value="<?php if(isset($naviera)) echo $naviera; else echo set_value('naviera');?>" aria-describedby="inputError2Status">
