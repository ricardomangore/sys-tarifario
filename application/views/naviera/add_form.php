<div class="row">
	<ul class="nav nav-pills">
	  <li role="presentation" class="active"><a href="<?php echo base_url();?>addnaviera"><i class="fa fa-plus-square"></i> Agregar</a></li>
	  <li role="presentation"><a href="<?php echo base_url();?>editnaviera/0"><i class="fa fa-pencil"></i> Editar</a></li>
	  <li role="presentation"><a href="<?php echo base_url();?>deletenaviera/0"><i class="fa fa-trash"></i> Eliminar</a></li>
	</ul>
</div>
<div class="row">
	...
	<div class="panel panel-default">
		...
		<form class="form-horizontal" method="POST" action="<?php echo base_url();?>addnaviera">
		  <div class="form-group <?php if(form_error('naviera')!='') echo 'has-error';?>">
		    <label for="region" class="col-sm-2 control-label">Naviera</label>
		    <div class="col-sm-4">
		      <input name="naviera" type="text" class="form-control" id="naviera" placeholder="Naviera" value="<?php echo set_value('naviera'); ?>" aria-describedby="inputError2Status">
		    </div>
		  </div>
