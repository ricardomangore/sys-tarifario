<div class="row">
	<ul class="nav nav-pills">
	  ...
	  <li role="presentation" class="active"><a href="<?php echo base_url();?>deleteregion/0"><i class="fa fa-trash"></i> Eliminar</a></li>
	</ul>
</div>
<div class="row">
	...
	<div class="panel panel-default">
		...
		<form class="form-horizontal" method="POST" action="<?php echo base_url();?>deleteregion/0">
